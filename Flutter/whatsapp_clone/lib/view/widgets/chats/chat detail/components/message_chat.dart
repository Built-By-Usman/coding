...
class MessageChat extends StatelessWidget {
  ...
  const MessageChat({super.key, required this.isSender, required this.message, required this.date});
          ...
          children: [
            ...
            Positioned(
              ...
              child: isSender
                  ? Row(
                children: [
                  Text(transferDate(date), style: TextStyle(fontSize: 13, color: AppColor.grey600)),
